    ...
    <div>
      ...
      <SLayout>
        <div className="grid grid-cols-1 lg:grid-cols-2">
          <div className="bg-cover bg-center bg-[url('https://smartdata.tonytemplates.com/cleaning-service-v3/ele-demo1/wp-content/uploads/sites/7/2017/06/about-page-img-2.jpg')]"></div>
          <div className="px-8">
            <ul className="py-2">
